    ...
    $.fn.biolife_init_carousel = function () {
        ...
        $(this).not('.slick-initialized').each(function () {
            ...
            if (config.vertical === true ) {
                config.prevArrow = '<span class="fa fa-chevron-up prev"></span>';
                config.nextArrow = '<span class="fa fa-chevron-down next"></span>';
            } else {
                config.prevArrow = '<span class="fa fa-chevron-left prev"></span>';
                config.nextArrow = '<span class="fa fa-chevron-right next"></span>';
            }
